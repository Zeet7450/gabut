...
const Hero = () => {
  ...
  return (
    <div className='px-4 sm:px-20 xl:px-32 relative inline-flex flex-col w-full justify-center bg-[url(/gradientBackground.png)] bg-cover bg-no-repeat min-h-screen' style={{ backgroundImage: `url(${gradientBackground})` }}>
      
      <div className='text-center mb-6'>
        <h1 className='text-3xl sm:text-5xl md:text-6xl 2xl:text-7xl font-semibold mx-auto leading-[1.2]'>
            Create amnameazing content with <span className='text-primary'> AI tools</span></h1>
      ...
      <div className='flex items-center gap-4 mt-8 mx-auto text-gray-600'>
        <img src={userGroup} alt="" className='h-8' />
         Trustes by 10k+ users
      </div>
