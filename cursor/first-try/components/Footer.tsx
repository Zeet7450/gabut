      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            >
              ...
              <p className="text-text-secondary mb-6 max-w-md">
                Your trusted e-commerce platform with AI-powered customer service. 
                Experience seamless shopping with intelligent assistance available 24/7.
              </p>
          ...
          <div>
            ...
            >
              <h3 className="text-lg font-semibold text-text-primary mb-6">Support</h3>
              <ul className="space-y-3">
          ...
          <div>
            ...
            >
              <h3 className="text-lg font-semibold text-text-primary mb-6">Legal</h3>
              <ul className="space-y-3">
        ...
        >
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="flex items-center space-x-2 text-text-muted">
              <span>© {currentYear} Sijual. Made with</span>
