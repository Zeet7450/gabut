          ...
          >
                ...
                <div className="space-y-4">
                  {cartItems.map((item) => (
                    <motion.div
                      ...
                      className="flex space-x-4 p-4 bg-gray-800/50 rounded-lg"
                    >
                      <Image
            ...
            {cartItems.length > 0 && (
              <div className="border-t border-gray-800 p-6">
                ...
                <button className="w-full bg-green-accent hover:bg-green-accent/90 text-white font-medium py-3 px-4 rounded-lg transition-colors duration-200">
                  Proceed to Checkout
                </button>
              </div>
            )}
